...
.controller 'fbFormObjectEditableController', ['$scope', '$injector', ($scope, $injector) ->
    ...
    $scope.setupScope = (formObject) ->
        ...
        $scope.$watch '[label, description, placeholder, required, options, type, validations]', ->
            formObject.label       = $scope.label
            formObject.description = $scope.description
            formObject.placeholder = $scope.placeholder
            formObject.required    = $scope.required
            formObject.options     = $scope.options
            formObject.validations = $scope.validations
            formObject.type        = $scope.type
        , yes
        ...
        $scope.typeOptions = component.typeOptions
    ...
    $scope.data =
        ...
        rollback: ->
            ...
            $scope.validations = @model.validations
